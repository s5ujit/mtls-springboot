@echo off
set CLIENT_KEYSTORE_DIR=..\client\src\main\resources
set SERVER_KEYSTORE_DIR=..\server\src\main\resources
set CLIENT_KEYSTORE=%CLIENT_KEYSTORE_DIR%\client-nonprod.jks
set SERVER_KEYSTORE=%SERVER_KEYSTORE_DIR%\server-nonprod.jks
set JAVA_CA_CERTS=%JAVA_HOME%\jre\lib\security\cacerts
...
:: Import the client and server public certificates into each other's keystore
